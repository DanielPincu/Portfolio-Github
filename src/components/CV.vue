<template>
  <div id="home">
    ...
    <div>
      ...
      <!-- Additional sections -->
      <div v-for="(additionalSection, index) in additionalSections" :key="'additionalSection' + index" class="mx-10 mt-5 flex flex-col bg-blue-200 dark:bg-red-200 rounded-full items-center justify-end h-16">
